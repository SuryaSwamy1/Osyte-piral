//@pilet v:2(webpackChunkpr_authpilet,{})
...
/* harmony import */ var _styles_auth_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../styles/auth.css */ "./src/styles/auth.css");
...
var Login = function Login(_ref) {
  var onSuccess = _ref.onSuccess,
    onSwitchToSignup = _ref.onSwitchToSignup;
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            ...
            _context.p = 1;
            _context.n = 2;
            return _services_authService__WEBPACK_IMPORTED_MODULE_2__.authService.login(formData);
          case 2:
            if (onSuccess) {
              onSuccess();
            }
          ...
          case 3:
            _context.p = 3;
            _t = _context.v;
            setError(((_err$response = _t.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.error) || 'Login failed. Please try again.');
          case 4:
            _context.p = 4;
            setLoading(false);
            return _context.f(4);
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
    ...
    children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        ...
        children: [error && (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
          ...
          disabled: loading,
          children: [loading && (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", {
            className: "loading-spinner"
          }), loading ? 'Signing in...' : 'Sign In']
        }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
          className: "auth-footer",
          children: ["Don't have an account?", ' ', (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("a", {
            href: "#",
            className: "auth-link",
...
var Signup = function Signup(_ref) {
  var onSuccess = _ref.onSuccess,
    onSwitchToLogin = _ref.onSwitchToLogin;
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)({
      email: '',
      password: '',
      firstName: '',
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          ...
          case 2:
            ...
            _context.p = 3;
            _context.n = 4;
            return _services_authService__WEBPACK_IMPORTED_MODULE_2__.authService.signup(formData);
          case 4:
            if (onSuccess) {
              onSuccess();
            }
          ...
          case 5:
            _context.p = 5;
            _t = _context.v;
            setError(((_err$response = _t.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.error) || 'Signup failed. Please try again.');
          case 6:
            _context.p = 6;
            setLoading(false);
            return _context.f(6);
    ...
    children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        ...
        children: [error && (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
          ...
          className: "auth-footer",
          children: ["Already have an account?", ' ', (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("a", {
            href: "#",
            className: "auth-link",
            onClick: function onClick(e) {
              e.preventDefault();
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            _context.n = 1;
            return axios__WEBPACK_IMPORTED_MODULE_0__["default"].post("".concat(API_URL, "/login"), credentials);
          case 1:
            response = _context.v;
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.n) {
          case 0:
            _context2.n = 1;
            return axios__WEBPACK_IMPORTED_MODULE_0__["default"].post("".concat(API_URL, "/signup"), data);
          case 1:
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
      ...
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.n) {
          ...
          case 1:
            _context3.n = 2;
            return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get("".concat(API_URL, "/verify"), {
              headers: {
...
(() => {
/*!***********************************************************************************************************!*\
  !*** ./node_modules/piral-cli-webpack5/lib/plugins/SheetLoader.js?cssName=main.css&piletName=auth-pilet! ***!
  \***********************************************************************************************************/
var d=document;var u=__webpack_require__.p+"main.css";var e=d.createElement("link");e.setAttribute('data-origin', "auth-pilet");e.type="text/css";e.rel="stylesheet";e.href=u+"?_="+Math.random();d.head.appendChild(e)
})();
...
/* harmony import */ var _components_Signup__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/Signup */ "./src/components/Signup.tsx");




function setup(app) {
  app.registerPage('/login', function () {
    return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_Login__WEBPACK_IMPORTED_MODULE_2__.Login, {
  ...
  app.registerPage('/signup', function () {
    return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_Signup__WEBPACK_IMPORTED_MODULE_3__.Signup, {
      onSuccess: function onSuccess() {
        window.location.href = '/';
      },
...
//# sourceMappingURL=piral-app-shell.js.map