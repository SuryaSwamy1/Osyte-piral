...
declare module "kras" {
  ...
  export function proxyRequest(req: ProxyRequestOptions, callback: ProxyCallback): Request;
  ...
  export interface BufferConstructor {
    ...
    from(str: WithImplicitCoercion<string> | {
      [typeof toPrimitive](hint: "string"): string;
     ...
     */
    byteLength(string: string | NodeJS_ArrayBufferView | ArrayBuffer | SharedArrayBuffer, encoding?: BufferEncoding): number;
    /**
  ...
  export interface Request extends Httpified, Stream.Stream {
    readable: boolean;
    writable: boolean;
    ...
    multipart(multipart: Array<RequestPart>): Request;
    ...
    ca?: string | Buffer | Array<string> | Array<Buffer> | undefined;
    har?: HttpArchiveRequest | undefined;
    headers: Headers___1;
    method: string;
    pool: PoolOptions;
    dests: Array<Stream.Readable>;
    callback?: RequestCallback | undefined;
    uri: Url.Url & {
      href: string;
      pathname: string;
    };
    proxy: null | string | Url.Url;
    tunnel: boolean;
    setHost: boolean;
    path: string;
    agent: false | Http.Agent | Https.Agent;
    body: Buffer | Array<Buffer> | string | Array<string> | Stream.Readable;
  ...
  export interface CookieJar {
    setCookie(cookieOrStr: Cookie | string, uri: string | Url.Url, options?: SetCookieOptions): void;
    getCookieString(uri: string | Url.Url): string;
    getCookies(uri: string | Url.Url): Array<Cookie>;
  }
  ...
  export interface HttpArchiveRequest {
    ...
    headers?: Array<NameValuePair> | undefined;
    postData?: {
      mimeType?: string | undefined;
      params?: Array<NameValuePair> | undefined;
    } | undefined;
  }

  export type PoolOptions = false | {
    [key: string]: Http.Agent | Https.Agent;
  } & ExtraPoolOptions | ExtraPoolOptions;

  export type RequestCallback = (error: any, response: Response, body: any) => void;
  ...
  export interface ExtraPoolOptions {
    maxSockets?: number | undefined;
  }

  export class Cookie___1 {
    static parse(cookieString: string, options?: ParseOptions): Cookie___1 | undefined;
    static fromJSON(strOrObj: string | object): Cookie___1 | null;
