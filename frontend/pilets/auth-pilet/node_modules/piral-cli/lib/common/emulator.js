...
function createEmulatorSources(sourceDir, externals, targetDir, targetFile, logLevel) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const piralPkg = yield (0, io_1.readJson)(sourceDir, constants_1.packageJson);
        const piralJsonPkg = yield (0, io_1.readJson)(sourceDir, constants_1.piralJson);
        ...
        yield (0, io_1.updateExistingJson)(rootDir, constants_1.packageJson, {
            ...
            pilets: Object.assign(Object.assign({}, pilets), { files: filesMap }),
            piralCLI: {
        ...
        yield (0, package_1.copyScaffoldingFiles)(sourceDir, rootDir, (_b = piralPkg.files) !== null && _b !== void 0 ? _b : []);
